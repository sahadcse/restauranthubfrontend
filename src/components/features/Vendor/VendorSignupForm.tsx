          ...
          <div className="flex justify-between pt-6">
            ...
            {!isStep2 && currentStep === 1 ? (
              <button
                ...
                className="px-8 py-2 bg-teal-600 text-white rounded-md hover:bg-teal-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center"
              >
                {isCreatingAccount ? (
                  <>
                    <svg

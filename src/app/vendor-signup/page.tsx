...
function VendorSignupContent() {
  ...
  // Enhanced debugging for step 2 validation
  if (isStep2) {
    console.log("Step 2 Validation Debug:");
    console.log("- User role:", user?.role);
    console.log("- Account status:", user?.accountStatus);
    console.log("- Token present:", !!token);
    console.log("- Required role: RESTAURANT_OWNER");
    console.log("- Required status: ACTIVE");
    console.log("- All user fields:", user);
  }
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className={isStep2 ? "lg:col-span-3" : "lg:col-span-2"}>
              ...
              ) : isStep2 && (!user?.role || !user?.accountStatus) ? (
                <div className="bg-white rounded-lg shadow-sm p-8 text-center">
                  <h2 className="text-xl font-semibold text-gray-900 mb-4">
                    Account Information Incomplete
                  </h2>
                  <p className="text-gray-600 mb-6">
                    Your account verification is incomplete. Please verify your
                    email again to get complete account information.
                  </p>
                  <div className="space-y-3">
                    <button
                  ...
                  {process.env.NODE_ENV === "development" && (
                    <div className="mt-4 text-xs text-gray-500 border-t pt-4">
                      <p>Debug Info:</p>
                      <p>Missing role: {!user?.role ? "Yes" : "No"}</p>
                      <p>
                        Missing accountStatus:{" "}
                ...
                <div className="bg-white rounded-lg shadow-sm p-8 text-center">
                  ...
                  {process.env.NODE_ENV === "development" && (
                    <div className="mt-4 text-xs text-gray-500 border-t pt-4">
                      ...
                      <p>
                        LocalStorage user:{" "}
                        {localStorage.getItem("userData") ? "exists" : "null"}
                      </p>
                      <p>
                        LocalStorage token:{" "}
